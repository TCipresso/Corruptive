...
public class Rook : MonoBehaviour
{
    ...
    private static Rook selectedPiece;
    ...
    private bool IsPathClear(string start, string end)
    {
        ...
        if (startRow == endRow)
        {
            for (char col = (char)(startColumn + columnIncrement); col != endColumn; col += (char)columnIncrement)
            {
                string position = col.ToString() + startRow;
        ...
        else if (startColumn == endColumn)
        {
            ...
            {
                string position = startColumn.ToString() + row;
                if (!IsSquareEmpty(position))
                {
                    return false;
                }
